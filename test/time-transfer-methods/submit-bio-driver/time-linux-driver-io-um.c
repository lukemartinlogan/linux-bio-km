...
int write_bypass(char *dev, size_t sector, void *usr_buf, size_t length, ktime_t *time_nsptr)
{
	struct nlmsghdr *nlh;
	struct km_request *rq;
	int code;
...
int read_bypass(char *dev, size_t sector, void *usr_buf, size_t length, ktime_t *time_nsptr)
{
    struct nlmsghdr *nlh;
    struct km_request *rq;
    int code;
